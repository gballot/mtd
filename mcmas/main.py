...
from mcmas import McmasExporter
...
g7 = Goal(children=[d3, a7], operation_type=OperationType.EDGE, reset=False, name="g7")
...
g4 = Goal(children=[d2, a4, g7], operation_type=OperationType.OR, reset=True, name="g4")
...
tree = Tree(gt)
mcmas = McmasExporter(tree, 10)
mcmas.export("output.ispl")
